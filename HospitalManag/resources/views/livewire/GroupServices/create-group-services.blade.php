<div>
    @if ($ServiceSaved)
        <div class="alert alert-info">The data was successfully saved !</div>
    @endif

    @if ($ServiceUpdated)
        <div class="alert alert-info">The data was successfully updated !</div>
    @endif
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="table-primary">
                                    <th>Service Name</th>
                                    <th width="200">Number Of Services</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-danger"
                                                wire:click.prevent="removeService({{ $index }})">Remove
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="col-lg-4 ml-auto text-right">
                        <table class="table pull-right">
                            ...
                            <tr>
                                <td style="color: red">Total With Taxe</td>
