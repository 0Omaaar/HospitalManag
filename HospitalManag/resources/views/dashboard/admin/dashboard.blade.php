...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            <div>
                <label class="tx-13">Number of Services</label>
                <h5>{{\App\Models\Admin\Service::count()}}</h5>
            </div>
            <div>
                <label class="tx-13">Number Of Group Services</label>
                <h5>{{\App\Models\Admin\Group::count()}}</h5>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
            ...
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Admin\Section::count()}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
