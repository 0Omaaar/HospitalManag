    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('invoicess.index')}}">On Traitment Invoices</a></li>
                    <li><a class="slide-item" href="{{route('completed_invoicess')}}">Completed Invoices</a></li>
                    <li><a class="slide-item" href="{{route('review_invoices')}}">On Review Invoices</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
