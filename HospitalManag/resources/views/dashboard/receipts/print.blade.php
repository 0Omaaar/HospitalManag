...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Catch Receipt</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Print
                    Receipt</span>
            </div>
        </div>
    </div>
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">Catch Receipt</h1>
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                <label class="tx-gray-600">Receipt Infos</label>
                                <p class="invoice-info-row"><span>Created At</span> <span>{{ $receipt->date }}</span>
                                </p>
